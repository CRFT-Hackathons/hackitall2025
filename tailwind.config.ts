  ...
  theme: {
    ...
    extend: {
      boxShadow: {
        shadow: "var(--shadow)",
        "border-primary":
          "0 1px var(--surface-a2), 0 -1px var(--surface-a3), 0 0 0 1px var(--surface-a4), var(--shadow)",
        "border-secondary":
          "0 1px var(--surface-a7), 0 -1px var(--surface-a8), 0 0 0 1px var(--surface-a9), var(--shadow)",
        "border-accent":
          "0 1px var(--accent-a5), 0 -1px var(--accent-a4), 0 0 0 1px var(--accent-a3)",
        "border-destructive":
          " 0 1px var(--danger-a5), 0 -1px var(--danger-a4), 0 0 0 1px var(--danger-a3)",
