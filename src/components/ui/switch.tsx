...
>(({ className, ...props }, ref) => (
  <SwitchPrimitives.Root
    className={cn(
      "peer inline-flex h-5 w-9 shrink-0 cursor-pointer items-center rounded-full border-2 border-transparent shadow-border-primary transition-colors focus-visible:outline-none focus-visible:shadow-active disabled:cursor-not-allowed disabled:opacity-50 data-[state=checked]:bg-accent data-[state=checked]:shadow-border-accent data-[state=unchecked]:bg-surface-4",
      className
    )}
    {...props}
    ref={ref}
